# Generated by Django 5.1 on 2024-11-18 17:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website_url', models.URLField(default='invalid websiteurl', max_length=2048)),
                ('url', models.URLField(default='invalid url', max_length=2048)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.URLField(default='invalid url', max_length=2048)),
                ('email', models.EmailField(blank=True, default='SMTP E515 : Email Not Found', max_length=255, null=True)),
